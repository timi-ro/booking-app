...
return [
    ...
    'description' => 'RESTful API for booking management system with offerings, time slots, and reservations.',
    ...
    'auth' => [
        ...
        'extra_info' => 'This API uses Laravel Sanctum for authentication. Include your bearer token in the Authorization header.',
    ],
